...
class AuthenticationService:
    ...
    def create_access_token(
        self, data: Dict, expires_in: Optional[int] = None, correlation_id: Optional[UUID] = None
    ) -> str:
        """
    ...
    def create_refresh_token(self, user_id: str, correlation_id: Optional[UUID] = None) -> str:
        """
