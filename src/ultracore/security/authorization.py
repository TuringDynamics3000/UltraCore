...
class AuthorizationService:
    ...
    async def assign_role(
        self, user_id: str, role: Role, assigned_by: str, correlation_id: Optional[UUID] = None
    ) -> None:
        """
    ...
    async def revoke_role(
        self, user_id: str, role: Role, revoked_by: str, correlation_id: Optional[UUID] = None
    ) -> None:
        """
    ...
    async def check_permission(
        self, user_id: str, permission: Permission, correlation_id: Optional[UUID] = None
    ) -> None:
        """
    ...
    def is_admin(self, user_id: str) -> bool:
        ...
        """
        return self.has_role(user_id, Role.ADMIN) or self.has_permission(user_id, Permission.ADMIN)
